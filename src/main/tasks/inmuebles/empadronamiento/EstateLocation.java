...
public class EstateLocation {
    public static void defineRandomLocation(WebDriver driver, ExtentTest extentTest){
        if (IsDisplayed.element(driver, UbicacionInmuebleUI.lstMacroDistrito, 1)){
        ...
        if (IsDisplayed.element(driver, UbicacionInmuebleUI.lstZonaBarrio, 1)){
            selectRandomOption(driver, UbicacionInmuebleUI.lstZonaBarrio);
        }
        if (IsDisplayed.element(driver, UbicacionInmuebleUI.lstZonaComunidad, 1)){
