package main.tasks.inmuebles.transferenciaNormalParcial;
...
public class TransferenciaNormalParcialPu extends GeneratorINM {
    protected String operacion;
    protected String numeroInmueble;

    public TransferenciaNormalParcialPu(){
        super();
        this.accessExcel = new AccessExcel(ConstantsINM.GENERATOR_DATA_FILE, ConstantsINM.TRANSFERENCIA_NORMAL_PARCIAL_PU_DATA_SHEET);
    ...
    public void execute() {
        try {
            ...
            LoadModule.fromSearcherOfMainMenuAndSubGrouper(this.driverApp, ConstantsINM.TRANSFERENCIA_NORMAL_PROPIEDAD_UNICA_TN_SUBGROUPER, ConstantsINM.TRANSFERENCIA_NORMAL_PARCIAL_MODULE);
